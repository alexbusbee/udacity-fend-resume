var bio = {
	...
	"welcomeMessage" : "Welcome! Welcome! Welcome! Welcome! Welcome! Welcome! Welcome! Welcome! Welcome! Welcome! Welcome! Welcome! Welcome! Welcome! Welcome! Welcome! Welcome! Welcome! Welcome! Welcome! Welcome! Welcome! Welcome!",
	"skills": [{
		"name": "Karate",
		"use": "self-defense",
	}, {
		"name": "Flight",
		"use": "traveling quickly",
	}, {
		"name": "Super strength",
		"use": "smashing stuff",
	}, {
...
if (bio.skills.length > 0) {
	...
	var formattedSkill = HTMLskills.replace("%data%", bio.skills[0].name);
	 $("#skills").append(formattedSkill + " for " + bio.skills[0].use);
	formattedSkill = HTMLskills.replace("%data%", bio.skills[1].name);
	 $("#skills").append(formattedSkill + " for " + bio.skills[1].use);
	formattedSkill = HTMLskills.replace("%data%", bio.skills[2].name);
	 $("#skills").append(formattedSkill + " for " + bio.skills[2].use);
	formattedSkill = HTMLskills.replace("%data%", bio.skills[3].name);
	 $("#skills").append(formattedSkill + " for " + bio.skills[3].use);
};
